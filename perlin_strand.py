...
LED_BRIGHTNESS = 255# set to to 0 for darkest and 255 for brightest
        ...
        #            blueColor = (float(led_index)/span)
         #           redColor = (float(led_index)/span)
              #      blueColor   = interp(led_index, 0,50,0,255)
                    blueColor   = int(interp(pnoise1(float(led_index+count)/span), 0, 1.0, 50, 255))
                    redColor    = int(interp(pnoise1(float(led_index+count+200)/span), 0, 1.0, 50, 255))
                    greenColor  = int(interp(pnoise1(float(led_index+count+400)/span), 0, 1.0, 50, 255))
